...
subtitle: "Microbiome x Nitrogen Global Analyses"
...
## Read in workspace
# load("data_analysis/2-microbiome_x_nitrogen-analyses/M_x_N-global_analyses-workspace.RData")
```
...
save.image("data_analysis/2-microbiome_x_nitrogen-analyses/M_x_N-global_analyses-workspace.RData")
```
