...
subtitle: "Microbiome x Nitrogen Analyses"
...
## Read in workspace
# load("data_analysis/2-microbiome_x_nitrogen-analyses/M_x_N-analyses-workspace.RData")
```
...
save.image("data_analysis/2-microbiome_x_nitrogen-analyses/M_x_N-analyses-workspace.RData")
```
