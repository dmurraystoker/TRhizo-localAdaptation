...
subtitle: "Microbiome x Nitrogen Global Model Fitting"
...
## Recode to Microbiome_Global_Global to test for global effects
# Biomass data
...
## Read in workspace
#load("data_analysis/M_x_N-global_model_fitting-workspace.RData")
```
...
aboveground.biomass.MN.LMM.2 <- lmer(
  sqrt(Aboveground_Biomass) ~ Microbiome_Global * Nitrogen
    + (Microbiome_Global | Population)
    + (Nitrogen | Population)
    + (Microbiome_Global:Nitrogen | Population)
    + (1 | Population)
    + (1 | Block),
  data = biomass.data,
  REML = TRUE
...
## Remove (1 | Microbiome_Global:Nitrogen:Population)
...
## Remove (1 | Microbiome_Global:Population) and (1 | Microbiome_Global:Nitrogen:Population)
...
# N:P = Non-normality detected (P = 0.008)
# P = Good
# B = Good
...
## Remove (1 | Nitrogen:Population) and (1 | Microbiome_Global:Nitrogen:Population)
...
save.image("data_analysis/1-microbiome_x_nitrogen-model_fitting/M_x_N-global_model_fitting-workspace.RData")
```
